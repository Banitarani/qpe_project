...
for(i=1;i<=7;i++){
    for(j=1;j<=3;j++){
if(document.getElementById('c${i} r${j}').style.backgroundColor== '${player}' && document.getElementById('c${i} r${j+1}').style.backgroundColor=='${player}'){
    alert('${player} wins')
    location.reload()
}
    }
...
for(i=1;i<=4;i++){
    for(j=1;j<=3;j++){
if(document.getElementById('c${i} r${j}').style.backgroundColor== '${player}' && document.getElementById('c${j+1} r${i}').style.backgroundColor=='${player}'&& document.getElementById('c${j+2} r${i}').style.backgroundColor=='${player}'&& document.getElementById('c${j+3} r${i}').style.backgroundColor=='${player}'){
    alert('${player} wins')
    location.reload()
}
    }
